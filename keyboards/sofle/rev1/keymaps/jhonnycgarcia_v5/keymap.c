...
/**
 * \brief LOWER layout base para Sofle (6 rows, 12 columns).
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
/**
 * \brief RAISE layout base para Sofle (6 rows, 12 columns).
 * ,----------------------------------------.                     ,-----------------------------------------.
 * | trans|      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | trans|   |  |  "   |      |      |      |                    |   ^  |  (   |  )   |  -   |   ´  |      |
...
#define LAYOUT_RAISE                                                                                                                                                                                                                         \
    ...
    /*|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|*/\
    KC_TRNS, KC_NO, KC_NO, KC_NO, S(KC_SLSH), KC_NO, KC_CTRL_G,  KC_CTRL_S, KC_PAST, KC_LBRC, KC_RBRC, S(KC_1), KC_BSLS, KC_NO,\
    /*|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|*/\
         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    /*.   \--------+--------+--------+---------+-------|                   |--------+--------+--------+---------+-------/ */
...
/**
 * \brief NUMPAD layout base para Sofle (6 rows, 12 columns).
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_wrapper(HOME_ROW_MOD_GACS(LAYOUT_LOWER)),
    [_RAISE] = LAYOUT_wrapper(HOME_ROW_MOD_GACS(LAYOUT_RAISE)),
