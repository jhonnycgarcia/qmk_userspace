...
```bash
# Compilar el keymap
qmk compile -kb sofle/rev1 -km jhonnycgarcia_v4
```

### Verificación y Linting
```bash
# Verificar sintaxis y estilo del código
qmk lint -km jhonnycgarcia_v4 -kb sofle/rev1 --strict

# Verificar configuración del keymap
qmk lint -km jhonnycgarcia_v4 -kb sofle/rev1
```
...
qmk compile -kb sofle/rev1 -km jhonnycgarcia_v4 -v

# Compilación con colores
qmk compile -kb sofle/rev1 -km jhonnycgarcia_v4 --color

# Compilación silenciosa
qmk compile -kb sofle/rev1 -km jhonnycgarcia_v4 -s
```
